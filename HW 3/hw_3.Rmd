...
```
For this logistic regression, there is an error rate of about 18.1%.  
...
For this LDA, the error rate is about 13.4%.
...
For KNN $(k = 1)$, we have an error rate of 45.9%.
...
For KNN $(k = 10)$, our error rate decreases to 11.9%.
...
For KNN $(k = 20)$, our error rate remains at 11.9%.